package com.truper.saen.authenticator.controller.test;
...
public class TestSecurityController {
	...
	public ResponseEntity<ResponseVO> decipherToken(ServletRequest request) 
	{
		...
		if(p1.isPresent() && p2.isPresent() && p3.isPresent() && p4.isPresent() && 
			...
			List<Permiso> collectionP1 = Arrays.asList(p1.get());
			List<Permiso> collectionP2 = Arrays.asList(p1.get(),p2.get());
			List<Permiso> collectionP3 = Arrays.asList(p3.get(),p4.get(),p5.get());
			List<Permiso> collectionP4 = Arrays.asList(p1.get(),p2.get(),p3.get(),p4.get(),p5.get(),p6.get(),p7.get(),p8.get());
			if(o1.isPresent() && o2.isPresent() && o3.isPresent() && o4.isPresent() ) {
				...
				List<Role> collectionR1 = Arrays.asList(o1.get());
				List<Role> collectionR2 = Arrays.asList(o1.get(),o2.get()); 
				List<Role> collectionR3 = Arrays.asList(o1.get(),o2.get(),o3.get(),o4.get());
